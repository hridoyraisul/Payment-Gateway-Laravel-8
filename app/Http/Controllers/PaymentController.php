...
class PaymentController extends Controller
{
    public function token()
    {
        ...
        File::put(storage_path().'/app/public/conig.json',$newJsonString);
        echo $idtoken;
    ...
    public function executePayment(Request $request){
        ...
        curl_close($url);
        $this->updateProdStatus($resultdatax);
        echo $resultdatax;
    }
    public function updateProdStatus($resltX){
        return $resltX;
    }
}
